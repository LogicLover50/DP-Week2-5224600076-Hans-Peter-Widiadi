...
Double-click `run.bat` inside the `Task 2` folder. It will automatically compile and run the program in a terminal window.

### Option 2 - Manual terminal
Open a terminal, navigate to the `Task 2` folder, then run:
```bash
